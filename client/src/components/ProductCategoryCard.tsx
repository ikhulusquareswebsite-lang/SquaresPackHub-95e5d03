  ...
  return (
    ...
    >
      <CardContent className="p-6 flex flex-col h-full">
        <div className="w-full h-32 mb-4 flex items-center justify-center bg-gradient-to-br from-[#E91E8C]/10 to-[#E41E3F]/10 rounded-lg overflow-hidden group-hover:from-[#E91E8C]/20 group-hover:to-[#E41E3F]/20 transition-colors duration-300">
